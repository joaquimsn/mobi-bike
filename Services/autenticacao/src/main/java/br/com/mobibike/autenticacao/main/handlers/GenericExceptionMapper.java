...
import br.com.mobibike.autenticacao.main.exceptions.SystemException;
	...
	public Response toResponse(Exception exception) {
		...
		if (exceptionToComapre instanceof ExposeBusinessException) {
			...
			return Response.status(exposeBusinessException.getHttpStatusCode()
					...
					.entity(MessageResponseError.of(exposeBusinessException.getSystemCode(), exposeBusinessException.getHttpStatusCode(), exposeBusinessException.getMessage(),
							exposeBusinessException.getDetail()))
					.build();
		}
