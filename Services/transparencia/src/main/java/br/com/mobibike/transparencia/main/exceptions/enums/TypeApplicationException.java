...
import br.com.mobibike.transparencia.main.exceptions.ApplicationException;
import br.com.mobibike.transparencia.main.exceptions.FatalErroStartupApplicationException;
...
public enum TypeApplicationException {
	...
	FATAL("system.fatal", "Falha interna", ApplicationException.class),
