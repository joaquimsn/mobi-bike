package br.com.mobibike.transparencia.domain.main.data;
...
public abstract class GenericDAO<T> implements Serializable {
	...
	public T save(final T entity) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException(
					"Ocorreu uma falha na persistencia: " + " cause: " + extractCause(e.getCause(), ""));
		}
	...
	public T update(final T entity) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA.buildException("Ocorreu uma falha na atualização: "
					+ e.getMessage() + " cause: " + extractCause(e.getCause(), ""));
		}
	...
	public void delete(final Serializable id) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA
					.buildException("Ocorreu uma falha na remoção: " + " cause: " + extractCause(e.getCause(), ""));
		}
	}
	...
	public Optional<T> findById(final Serializable id) {
		try {
			...
			throw TypeApplicationException.PERSISTENCIA
					.buildException("Ocorreu uma falha consulta: " + " cause: " + extractCause(e.getCause(), ""));
		}
	}
	...
	public List<T> findAll() {
		...
		try {
			...
			throw TypeApplicationException.PERSISTENCIA
					.buildException("Ocorreu uma falha na consulta: " + " cause: " + extractCause(e.getCause(), ""));
		}
	}
