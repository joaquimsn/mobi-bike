package br.com.mobibike.coletor.main.exceptions.enums;
...
public enum TypeExposeBusinessException {
	...
	CONTRATO_VIOLADO("geral.contratoViolado", "O dado informado não atende o padrão da model", BikeHttpStatusCode.CONTRATO_VIOLADO),
	NAO_ENCONTRADO("geral.dadoNaoEncontrado", "Dado não encontrado", BikeHttpStatusCode.RECURSO_NAO_ENCONTRADO),
	REGRA_GERAL("geral.regraNecocio", "Regra de negócio violada", BikeHttpStatusCode.CONTRATO_VIOLADO),
	REGRA_CAMPOS_ENTITY("entity.campo.regraNegocio", "Existem campos obrigatórios não preenchidos", BikeHttpStatusCode.VALIDACAO_CAMPOS),
